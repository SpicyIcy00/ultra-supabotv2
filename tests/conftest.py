...
def _needs_database(item) -> bool:
    ...
    pure = ("test_deployment_contract", "test_legacy_auth_contract", "test_storehub_parser", "test_storehub_import_contract",
            ...
            "test_understand_contract", "test_stock_history_contract", "test_replenishment_contract", "test_purchase_plan_contract", "test_supplier_map_contract", "test_judgment_contract", "test_beliefs_contract")
