...
`python` cannot import the backend (pinned SQLAlchemy).
    ...
    .venv\Scripts\python.exe ops/verify_integration.py pure     # 1,965 here, 1,961 in CI (P2S.10)
...
(the link the platform returned on the 2026-09-18 republish, version 71 after P2S.10). **Since
