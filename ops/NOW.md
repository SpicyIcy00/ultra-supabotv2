...
| Head | `a3003ef` — **pushed and live 2026-09-13**, carrying 32 commits that had sat unpushed: P1.b's default composition (`agent/default_composition.py`), the v2 voice suite (`bfb168f`), the $0 replay (`235d236`) and P1.g (`c508965`). |
