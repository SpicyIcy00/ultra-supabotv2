...
`python` cannot import the backend (pinned SQLAlchemy).
    ...
    .venv\Scripts\python.exe ops/verify_integration.py pure     # 2,064 here (P3.h + products + the BOM fix, 2026-09-19); CI not re-counted
