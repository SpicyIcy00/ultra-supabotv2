...
`python` cannot import the backend (pinned SQLAlchemy).
    ...
    .venv\Scripts\python.exe ops/verify_integration.py pure     # 2,015 here (P2S.✓, 2026-09-18); CI not re-counted
