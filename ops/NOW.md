...
| Head | `cedd6b3` (P0.6) — **local, NOT pushed**, on top of `4c0c9f9`, also unpushed. Two commits ahead of `origin/main`; neither carries a migration. |
| Live | **`3998873`**, confirmed from `/health` on 2026-09-13: schema `w7x8y9z0a1b2` current and expected, `schema_checked: live`. Read it rather than believing this row — `a01706b` was recorded here as live and three commits had landed since. |
