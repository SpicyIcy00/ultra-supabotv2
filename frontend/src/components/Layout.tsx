...
const navItems = [
  ...
  // DELIBERATELY ABSENT: 'storehub_imports'. The upload page is one of BOB'S
  // screens — it renders in his chrome and is listed in his rail under
  // Sources (P3.h, the owner: "it should be a page in bob not supabot").
  // It was here for one session; a link from both places is two doors to one
  // room, and the room is his.
