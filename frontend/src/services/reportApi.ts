...
/**
 * Post replenishment shipment plan data to Google Sheets via backend proxy.
 * Uses the same column layout as product sales — "Ordered Qty" maps to requested_ship_qty.
 *
 * @param items - Filtered ShipmentPlanItem[] to post (should be for a single store)
 * @param sheetName - Sheet tab name (typically the store name)
 */
