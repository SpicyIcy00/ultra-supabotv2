/**
 * Decisions — what you did with what George raised.
 *
 ...
 * back: George reads them himself when he ranks the morning, and says on the
...
export async function recordDecision(d: Decision): Promise<void> {
  await axios.post('/api/v1/george/decisions', d);
}
